...
| **[Parallel Grid Processing](https://github.com/MostafaAkram-off/parallel-mpi-project)** | University parallel-computing project: heat diffusion, matrix multiplication, ring communication and deadlock demos. | C++ · MPI · CMake |

## 🛠 Tech Stack

- **Mobile** — Flutter, Dart, Material Design, responsive UI, dark/light theming, RTL & Arabic UI
...
- **Testing & workflow** — flutter_test, Git & GitHub (branch-per-feature, pull requests)
- **Other languages** — C++, C, Python, Java
- **Tools** — Postman, VS Code, Android Studio
